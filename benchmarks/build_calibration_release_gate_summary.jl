...
api_contract_rationale = api_contract_rationale * " The voltage-start transfer audit is $bmopf_voltage_start_api_status; the proposed public setter/data symbols remain $bmopf_voltage_start_api_proposal, so the current staged-context workaround remains experimental and the contract is ready for BMOPFTools review."
