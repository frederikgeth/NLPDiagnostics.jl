...
real_kkt_boundary_review = read_summary("docs/real_99bus_kkt_boundary_review_summary.json")
...
rank_threshold_classification = read_summary("docs/rank_threshold_disagreement_summary.json")
rank_threshold_policy_review = read_summary("docs/rank_threshold_policy_review_summary.json")
...
saved_result_bmopf_scaling_diagnostics = read_summary("docs/bmopf_saved_result_scaling_diagnostics_summary.json")
saved_result_bmopf_quality = read_summary("docs/bmopf_saved_result_quality_summary.json")
saved_result_bmopf_rerun = read_summary("docs/bmopf_si_bounded_rerun_summary.json")
saved_result_bmopf_candidate_validation = read_summary("docs/bmopf_si_rerun_candidate_validation_summary.json")
saved_result_bmopf_promoted_sparse = read_summary("docs/bmopf_promoted_sparse_rank_summary.json")
...
runtime_solver_scaling_plan = read_summary("docs/bmopf_solver_scaling_extension_plan.json")
runtime_solver_scaling_extension = read_summary("docs/bmopf_solver_scaling_extension_summary.json")
runtime_solver_scaling_madnlp = read_summary("docs/bmopf_solver_scaling_extension_madnlp_summary.json")
runtime_solver_scaling_cross_solver = read_summary("docs/bmopf_solver_scaling_cross_solver_summary.json")
runtime_combined_large_probe = read_summary("docs/bmopf_combined_mv_lv_large_probe_summary.json")
runtime_combined_budget_extension = read_summary("docs/bmopf_combined_mv_lv_budget_extension_summary.json")
runtime_combined_50iter_probe = read_summary("docs/bmopf_combined_mv_lv_50iter_probe_summary.json")
runtime_combined_feasibility_probe = read_summary("docs/bmopf_combined_mv_lv_feasibility_probe_summary.json")
runtime_combined_transfer_probe = read_summary("docs/bmopf_combined_mv_lv_feasibility_start_transfer_summary.json")
runtime_combined_transfer_isolated = read_summary("docs/bmopf_combined_mv_lv_feasibility_start_transfer_isolated_summary.json")
runtime_combined_transfer_budget_sweep = read_summary("docs/bmopf_combined_mv_lv_transfer_budget_sweep_summary.json")
runtime_combined_transfer_budget_sweep_validation = read_summary("docs/bmopf_transfer_budget_sweep_validation_summary.json")
runtime_combined_transfer_budget_boundary = read_summary("docs/bmopf_transfer_budget_boundary_summary.json")
runtime_combined_load_sweep = read_summary("docs/bmopf_combined_mv_lv_load_multiplier_sweep_summary.json")
runtime_combined_load_sweep_validation = read_summary("docs/bmopf_combined_mv_lv_load_sweep_validation_summary.json")
runtime_combined_load_boundary_refinement = read_summary("docs/bmopf_combined_mv_lv_load_boundary_refinement_summary.json")
runtime_combined_load_boundary_refinement_validation = read_summary("docs/bmopf_combined_mv_lv_load_boundary_refinement_validation_summary.json")
runtime_combined_madnlp_boundary = read_summary("docs/bmopf_combined_mv_lv_madnlp_boundary_summary.json")
runtime_combined_madnlp_boundary_validation = read_summary("docs/bmopf_combined_mv_lv_madnlp_boundary_validation_summary.json")
runtime_combined_solver_boundary_consistency = read_summary("docs/bmopf_combined_mv_lv_solver_boundary_consistency_summary.json")
runtime_combined_load_fine_boundary = read_summary("docs/bmopf_combined_mv_lv_load_fine_boundary_summary.json")
runtime_combined_load_fine_boundary_validation = read_summary("docs/bmopf_combined_mv_lv_load_fine_boundary_validation_summary.json")
...
bmopf_transfer_report_validation = read_summary("docs/bmopf_transfer_report_validation_summary.json")
bmopf_transfer_report_isolated_validation = read_summary("docs/bmopf_transfer_report_isolated_validation_summary.json")
...
api_ownership_queue_count = get(api_ownership_decisions, "queue_count", 0)
api_ownership_queue_complete = get(api_ownership_decisions, "queue_complete", false)
...
bmopf_voltage_start_api_proposal = isempty(bmopf_voltage_start_api_missing) ?
    "available" : "unimplemented (" * join(bmopf_voltage_start_api_missing, ", ") * ")"
bmopf_voltage_start_transfer_report_ready = get(
    get(bmopf_voltage_start_api, "current_workaround", Dict{String,Any}()),
    "typed_transfer_report_ready",
    false,
)
bmopf_transfer_report_validation_status = get(bmopf_transfer_report_validation, "status", "missing")
bmopf_transfer_report_isolated_validation_status = get(
    bmopf_transfer_report_isolated_validation, "status", "missing",
)
...
runtime_solver_plan_status = get(runtime_solver_scaling_plan, "status", "missing")
runtime_solver_plan_case_count = length(get(runtime_solver_scaling_plan, "planned_cases", Any[]))
runtime_solver_extension_record_count = get(runtime_solver_scaling_extension, "record_count", 0)
runtime_solver_extension_solved_count = get(runtime_solver_scaling_extension, "solved_count", 0)
runtime_solver_extension_timeout_count = get(runtime_solver_scaling_extension, "timeout_count", 0)
runtime_solver_madnlp_solved_count = get(runtime_solver_scaling_madnlp, "solved_count", 0)
runtime_solver_cross_pair_count = get(runtime_solver_scaling_cross_solver, "snapshot_pair_count", 0)
runtime_solver_cross_both_solved_count = get(runtime_solver_scaling_cross_solver, "both_solved_pair_count", 0)
runtime_combined_large_probe_policy_count = get(runtime_combined_large_probe, "policy_count", 0)
runtime_combined_large_probe_solver_count = get(runtime_combined_large_probe, "all_reached_solver", false) ? runtime_combined_large_probe_policy_count : 0
runtime_combined_budget_solver_count = get(runtime_combined_budget_extension, "all_reached_solver", false) ? get(runtime_combined_budget_extension, "policy_count", 0) : 0
runtime_combined_50iter_solver_count = get(runtime_combined_50iter_probe, "all_reached_solver", false) ? get(runtime_combined_50iter_probe, "policy_count", 0) : 0
runtime_combined_feasibility_status = get(runtime_combined_feasibility_probe, "status", "missing")
runtime_combined_feasibility_slack = get(runtime_combined_feasibility_probe, "total_slack_magnitude_A", nothing)
runtime_combined_feasibility_init_scalars = get(
    get(runtime_combined_feasibility_probe, "initialization", Dict{String,Any}()),
    "finite_scalar_count", 0,
)
runtime_combined_transfer_records = get(runtime_combined_transfer_probe, "records", Any[])
runtime_combined_transfer_applied = isempty(runtime_combined_transfer_records) ? 0 : maximum(
    Int(get(record, "transferred_voltage_start_count", 0))
    for record in runtime_combined_transfer_records
)
runtime_combined_transfer_status = get(runtime_combined_transfer_probe, "status", "missing")
runtime_combined_transfer_native_bytes = isempty(runtime_combined_transfer_records) ? nothing :
    get(runtime_combined_transfer_records[1], "solve_allocated_bytes", nothing)
runtime_combined_transfer_bytes = length(runtime_combined_transfer_records) < 2 ? nothing :
    get(runtime_combined_transfer_records[2], "solve_allocated_bytes", nothing)
runtime_combined_transfer_budget_sweep_status = get(runtime_combined_transfer_budget_sweep, "status", "missing")
runtime_combined_transfer_budget_sweep_completed = get(runtime_combined_transfer_budget_sweep, "completed_count", 0)
runtime_combined_transfer_budget_sweep_budgets = get(runtime_combined_transfer_budget_sweep, "budgets", Any[])
runtime_combined_transfer_budget_sweep_termination_statuses = get(
    runtime_combined_transfer_budget_sweep, "termination_statuses", Dict{String,Any}(),
)
runtime_combined_transfer_budget_sweep_all_limited = get(
    runtime_combined_transfer_budget_sweep, "all_hard_runs_iteration_limited", false,
)
runtime_combined_transfer_budget_sweep_validation_status = get(
    runtime_combined_transfer_budget_sweep_validation, "status", "missing",
)
runtime_combined_transfer_budget_sweep_high_budget_pairs = get(
    runtime_combined_transfer_budget_sweep_validation, "high_budget_pair_count", 0,
)
runtime_combined_transfer_budget_boundary_status = get(
    runtime_combined_transfer_budget_boundary, "status", "missing",
)
runtime_combined_transfer_budget_boundary_high_budget_stable = get(
    runtime_combined_transfer_budget_boundary, "high_budget_stable", false,
)
runtime_combined_load_sweep_status = get(runtime_combined_load_sweep, "status", "missing")
runtime_combined_load_sweep_qualified_count = get(runtime_combined_load_sweep, "hard_locally_solved_count", 0)
runtime_combined_load_sweep_validation_status = get(runtime_combined_load_sweep_validation, "status", "missing")
runtime_combined_load_boundary_refinement_status = get(runtime_combined_load_boundary_refinement, "status", "missing")
runtime_combined_load_boundary_refinement_validation_status = get(
    runtime_combined_load_boundary_refinement_validation, "status", "missing",
)
runtime_combined_madnlp_boundary_status = get(runtime_combined_madnlp_boundary, "status", "missing")
runtime_combined_madnlp_boundary_validation_status = get(
    runtime_combined_madnlp_boundary_validation, "status", "missing",
)
runtime_combined_solver_boundary_consistency_status = get(
    runtime_combined_solver_boundary_consistency, "status", "missing",
)
runtime_combined_solver_boundary_agreement_count = get(
    runtime_combined_solver_boundary_consistency, "agreement_count", 0,
)
runtime_combined_load_fine_boundary_status = get(runtime_combined_load_fine_boundary, "status", "missing")
runtime_combined_load_fine_boundary_validation_status = get(
    runtime_combined_load_fine_boundary_validation, "status", "missing",
)
runtime_combined_isolated_measured_count = get(runtime_combined_transfer_isolated, "measured_count", 0)
runtime_combined_isolated_peak_range = get(runtime_combined_transfer_isolated, "peak_rss_bytes_range", Any[])
runtime_combined_allocator_peak_available_count = get(
    runtime_combined_transfer_isolated, "allocator_peak_available_count", 0,
)
...
analyze_external_peak = get(analyze_scaling_readiness, "external_peak_probe", Dict{String,Any}())
analyze_external_peak_status = get(analyze_external_peak, "status", "unavailable")
analyze_external_peak_tool = get(analyze_external_peak, "tool", "unavailable")
analyze_external_peak_portability = get(analyze_scaling_readiness, "external_peak_portability", Dict{String,Any}())
analyze_external_peak_portability_status = get(analyze_external_peak_portability, "status", "unavailable")
analyze_allocator_telemetry = get(analyze_scaling_readiness, "allocator_telemetry", Dict{String,Any}())
analyze_allocator_status = get(analyze_allocator_telemetry, "status", "unavailable")
analyze_allocator_peak_count = get(analyze_allocator_telemetry, "peak_available_count", 0)
analyze_allocator_portability = get(analyze_scaling_readiness, "allocator_portability", Dict{String,Any}())
analyze_allocator_portability_status = get(analyze_allocator_portability, "status", "unavailable")
analyze_allocator_boundary = get(analyze_scaling_readiness, "allocator_boundary", Dict{String,Any}())
analyze_allocator_boundary_status = get(analyze_allocator_boundary, "status", "unavailable")
...
rank_threshold_classified_disagreements = get(rank_threshold_classification, "threshold_backend_disagreement_count", 0)
rank_threshold_classification_hard_mismatches = get(rank_threshold_classification, "hard_control_mismatch_count", 0)
rank_threshold_policy_review_status = get(rank_threshold_policy_review, "status", "missing")
rank_threshold_policy_decision = get(rank_threshold_policy_review, "decision", nothing)
...
saved_result_bmopf_units = join(get(saved_result_bmopf_campaign, "result_units", Any[]), "/")
saved_result_bmopf_spans = get(saved_result_bmopf_campaign, "endpoint_span_diagnostics", Dict{String,Any}())
saved_result_bmopf_overall_spans = get(saved_result_bmopf_spans, "overall", Dict{String,Any}())
saved_result_bmopf_rank_delta_span = get(get(saved_result_bmopf_overall_spans, "rank_delta", Dict{String,Any}()), "range", nothing)
saved_result_bmopf_condition_ratio_span = get(get(saved_result_bmopf_overall_spans, "condition_proxy_ratio_row_column_over_unscaled", Dict{String,Any}()), "range", nothing)
saved_result_bmopf_paired_count = get(saved_result_bmopf_scaling_diagnostics, "paired_snapshot_count", 0)
saved_result_bmopf_unit_dependent_count = get(saved_result_bmopf_scaling_diagnostics, "unit_dependent_rank_outcome_count", 0)
saved_result_bmopf_incomplete_sensitive_count = get(saved_result_bmopf_scaling_diagnostics, "incomplete_provenance_sensitive_record_count", 0)
saved_result_bmopf_quality_available = get(saved_result_bmopf_quality, "available_endpoint_count", 0)
saved_result_bmopf_quality_usable = get(saved_result_bmopf_quality, "usable_solver_endpoint_count", 0)
saved_result_bmopf_quality_bad = get(saved_result_bmopf_quality, "nonfinite_or_unsolved_endpoint_count", 0)
saved_result_bmopf_rerun_cases = get(saved_result_bmopf_rerun, "case_count", 0)
saved_result_bmopf_rerun_successes = get(saved_result_bmopf_rerun, "bounded_success_count", 0)
saved_result_bmopf_candidate_count = get(saved_result_bmopf_candidate_validation, "candidate_count", 0)
saved_result_bmopf_candidate_usable = get(saved_result_bmopf_candidate_validation, "candidate_usable_solver_endpoint_count", 0)
saved_result_bmopf_promoted_before_sensitive = get(saved_result_bmopf_promoted_sparse, "before_scaling_sensitive_count", 0)
saved_result_bmopf_promoted_after_sensitive = get(saved_result_bmopf_promoted_sparse, "after_scaling_sensitive_count", 0)
saved_result_bmopf_promoted_after_incomplete = get(saved_result_bmopf_promoted_sparse, "after_incomplete_mapping_count", 0)
saved_result_bmopf_promoted_count = get(saved_result_bmopf_promoted_sparse, "record_count", 0)
t15_t16_tranche = read_summary("docs/bmopf_t15_t16_tranche_summary.json")
t15_t16_tranche_endpoint_count = get(t15_t16_tranche, "endpoint_count", 0)
t15_t16_tranche_pair_count = get(t15_t16_tranche, "paired_snapshot_count", 0)
t15_t16_tranche_unit_dependent_count = get(t15_t16_tranche, "unit_dependent_rank_outcome_count", 0)
t15_t16_tranche_mapping_complete = get(t15_t16_tranche, "all_mapping_complete", false)
t15_t16_tranche_sensitive_count = get(t15_t16_tranche, "scaling_sensitive_endpoint_count", 0)
rank_policy_gate_pass = rank_threshold_policy_review_status == "accepted_bounded_policy" &&
    rank_threshold_policy_decision == "accept_policy_boundary" &&
    rank_hard_controls > 0 && rank_hard_mismatches == 0 && rank_hard_unavailable == 0 &&
    rank_threshold_classification_hard_mismatches == 0 &&
    rank_sparse_only_mismatches == 0 && saved_result_bmopf_count > 0 &&
    saved_result_bmopf_sensitive == 0 && saved_result_bmopf_quality_available > 0 &&
    saved_result_bmopf_quality_available == saved_result_bmopf_quality_usable &&
    saved_result_bmopf_quality_bad == 0 && saved_result_bmopf_promoted_after_incomplete == 0 &&
    saved_result_bmopf_promoted_after_sensitive == 0 && t15_t16_tranche_mapping_complete
rank_policy_review_sentence = rank_policy_gate_pass ?
    "The project-owner-authorized decision accepts this bounded policy while retaining current defaults; threshold disagreements remain visible and no algebraic-rank or physical-cause claim is promoted." :
    "The policy review record is $rank_threshold_policy_review_status and does not close the bounded release gate."
...
api_contract_rationale = api_contract_rationale * " The voltage-start transfer audit is $bmopf_voltage_start_api_status; the proposed public setter/data symbols remain $bmopf_voltage_start_api_proposal, so the current staged-context workaround remains experimental and the contract is ready for BMOPFTools review. Its typed transfer report is ready=$bmopf_voltage_start_transfer_report_ready, with validation errors retained as structured records. The checked-in direct and isolated transfer evidence has standalone report-validation status=$bmopf_transfer_report_validation_status/$bmopf_transfer_report_isolated_validation_status."
...
function gate(id, status, rationale, evidence; blocking=false)
    evidence = id == "numerical_rank_false_positive_negative_statistics" ?
        vcat(evidence, ["docs/bmopf_saved_result_sparse_rank_campaign_summary.json", "benchmarks/summarize_bmopf_saved_result_sparse_rank_campaign.jl", "docs/bmopf_saved_result_scaling_diagnostics_summary.json", "benchmarks/summarize_bmopf_saved_result_scaling_diagnostics.jl"]) : evidence
    Dict{String,Any}(
        "id" => id,
        "status" => status,
        "blocking" => blocking,
...
gates = Dict{String,Any}[
    ...
    gate(
        ...
        rank_policy_gate_pass ? "pass" : "partial",
        "The aggregate rank-statistics ledger now joins $rank_hard_controls complete hard controls with $rank_hard_mismatches mismatches and $rank_hard_unavailable unavailable results, plus $rank_threshold_records threshold-sensitive controls with $rank_threshold_disagreements backend disagreements. Per-record, backend-specific confusion counts use truth-positive and truth-negative denominators, with unavailable results reported separately. These selected, related cases provide descriptive coverage only; no inferential error-rate bound is claimed. This includes the seeded randomized and controlled perturbation corpora plus a deterministic adversarial extension of $rank_adversarial_records records ($rank_adversarial_hard_controls hard controls, $rank_adversarial_mismatches hard-control mismatches, $rank_adversarial_unavailable unavailable). Disagreements remain tolerance evidence. The dedicated disagreement ledger classifies $rank_threshold_classified_disagreements threshold-sensitive backend disagreements with $rank_threshold_classification_hard_mismatches hard-control mismatches, without changing any tolerance. $rank_policy_review_sentence A guarded sparse-only extension contributes $rank_sparse_only_records records with $rank_sparse_only_mismatches sparse mismatches while intentionally disabling dense SVD. The cross-backend calibration matrix now retains $(length(rank_cross_backend_rows)) corpus rows separating dense/sparse hard-control agreement, threshold-sensitive disagreement, and sparse-only coverage. The separate smallest-singular corpus adds $smallest_singular_case_count adversarial cases with $smallest_singular_agreement_count dense-free crosscheck agreements and $smallest_singular_adverse_count expected adverse relations. The third-backend capability validator reports status=$rank_third_backend_status, adapter=$rank_third_backend_adapter_status: $rank_third_backend_reason_sentence. The reviewed internal normal-eigen path contributes a bounded $normal_eigen_records-record campaign with $normal_eigen_hard_controls hard controls and $normal_eigen_disagreements expected squared-spectrum threshold disagreement(s). Its policy-persistence follow-up adds $normal_eigen_policy_records records; $normal_eigen_repeatability_failures expose same-point span instability and $normal_eigen_policy_disagreements cross-backend policy disagreements. Trusted BMOPFTools validation now covers $normal_eigen_bmopf_snapshots successful snapshots and $normal_eigen_bmopf_records policy records, with $normal_eigen_bmopf_agreements cross-backend agreements, $normal_eigen_bmopf_unavailable unavailable policy comparisons; $normal_eigen_bmopf_guarded_label open. A guarded 538-bus synthetic coordinate probe adds sparse-only ranks $large_sparse_bmopf_unscaled_rank and $large_sparse_bmopf_row_column_rank (delta $large_sparse_bmopf_rank_delta). The saved BMOPFTools campaign now covers $saved_result_bmopf_count endpoints in $saved_result_bmopf_units result units, with $saved_result_bmopf_stable scaling-stable and $saved_result_bmopf_sensitive scaling-sensitive records; its endpoint rank-delta span is $saved_result_bmopf_rank_delta_span and condition-proxy ratio span is $saved_result_bmopf_condition_ratio_span. The paired SI/PU diagnostic covers $saved_result_bmopf_paired_count snapshots and identifies $saved_result_bmopf_unit_dependent_count unit-dependent rank outcomes; all $saved_result_bmopf_incomplete_sensitive_count sensitive records remain provenance-incomplete and are retained as a release boundary. The reviewed t15/t16 tranche adds $t15_t16_tranche_endpoint_count endpoints across $t15_t16_tranche_pair_count paired snapshots with $t15_t16_tranche_unit_dependent_count unit-dependent outcomes, $t15_t16_tranche_sensitive_count sparse-rank-sensitive endpoints, and complete mapping=$t15_t16_tranche_mapping_complete. The saved 538-bus solver-result point adds ranks $large_sparse_bmopf_saved_unscaled_rank and $large_sparse_bmopf_saved_row_column_rank (delta $large_sparse_bmopf_saved_rank_delta), showing scaling-stable sparse evidence at a provenance-complete endpoint. The saved-result quality audit covers $saved_result_bmopf_quality_available available endpoints, of which $saved_result_bmopf_quality_usable are usable solver endpoints and $saved_result_bmopf_quality_bad are nonfinite or unsolved; the latter are excluded from physical endpoint interpretation. The bounded rerun solved $saved_result_bmopf_rerun_successes/$saved_result_bmopf_rerun_cases excluded cases, candidate validation passed $saved_result_bmopf_candidate_usable/$saved_result_bmopf_candidate_count, and explicit promotion followed by a seven-case sparse re-audit now leaves $saved_result_bmopf_promoted_after_incomplete incomplete mappings and $saved_result_bmopf_promoted_after_sensitive scaling-sensitive cases (before: $saved_result_bmopf_promoted_before_sensitive).",
        ["docs/randomized_rank_oracle_calibration_summary.json", "docs/large_sparse_rank_oracle_summary.json", "docs/rank_perturbation_sweep_summary.json", "docs/rank_adversarial_extension_summary.json", "docs/rank_calibration_statistics_summary.json", "docs/rank_threshold_disagreement_summary.json", "docs/rank_threshold_policy_review_summary.json", "docs/calibration_results.md", "benchmarks/summarize_rank_threshold_disagreements.jl", "benchmarks/review_rank_threshold_policy.jl", "docs/rank_third_backend_capability_summary.json", "benchmarks/validate_rank_third_backend.jl", "docs/normal_eigen_rank_calibration_summary.json", "benchmarks/calibrate_normal_eigen_rank_backend.jl", "docs/normal_eigen_policy_persistence_summary.json", "benchmarks/calibrate_normal_eigen_policy_persistence.jl", "docs/bmopf_normal_eigen_jacobian_validation_summary.json", "benchmarks/bmopf_normal_eigen_jacobian_validation.jl", "docs/bmopf_large_sparse_rank_screen_summary.json", "docs/bmopf_large_sparse_rank_screen_saved_result_summary.json", "benchmarks/summarize_bmopf_large_sparse_rank_screen.jl", "docs/smallest_singular_calibration_summary.json", "benchmarks/calibrate_restarted_smallest_singular.jl", "docs/bmopf_538bus_saved_result_time_coverage_summary.json", "benchmarks/summarize_bmopf_538bus_saved_result_time_coverage.jl", "docs/bmopf_saved_result_quality_summary.json", "benchmarks/summarize_bmopf_saved_result_quality.jl", "docs/bmopf_si_bounded_rerun_summary.json", "benchmarks/summarize_bmopf_si_rerun.jl", "docs/bmopf_si_rerun_candidate_validation_summary.json", "benchmarks/validate_bmopf_rerun_candidates.jl", "docs/bmopf_promoted_sparse_rank_summary.json", "benchmarks/summarize_bmopf_promoted_sparse_rank.jl", "docs/bmopf_t15_t16_tranche_summary.json", "benchmarks/summarize_bmopf_t15t16_tranche.jl"],
        blocking=!rank_policy_gate_pass,
    ),
    gate(
        "runtime_memory_scaling",
        "partial",
        "The synthetic sparse ladder provides $(length(runtime_records)) warm-up-aware runtime/allocation records across $(length(runtime_dimensions)) dimensions, and an isolated child-process ladder adds $(length(isolated_runtime_records)) records across $(length(isolated_runtime_dimensions)) dimensions with per-dimension Sys.maxrss high-water observations. The companion trend ledger covers $isolated_runtime_workloads workloads; descriptive runtime log-log slopes range from $(isfinite(isolated_runtime_slope_minimum) ? round(isolated_runtime_slope_minimum; digits=3) : "unavailable") to $(isfinite(isolated_runtime_slope_maximum) ? round(isolated_runtime_slope_maximum; digits=3) : "unavailable"), with stage attribution retained per workload. Within-dimension stage timing repeatability is also retained; the largest observed stage coefficient of variation at the largest dimension is $(isnothing(isolated_runtime_timing_cv_maximum) ? "unavailable" : string(round(isolated_runtime_timing_cv_maximum; digits=3))). The runtime readiness matrix now joins $runtime_readiness_coverage_count bounded synthetic, public-API, isolated-process, BMOPFTools adapter, and BMOPFTools solver-workload coverage rows while retaining $runtime_readiness_open_gap_count open release-evidence gaps. The bounded solver-workload ledger contributes $runtime_solver_measured_count measured records and $runtime_solver_guarded_count explicit full-case size guards; the Ipopt extension adds $runtime_solver_extension_solved_count/$runtime_solver_extension_record_count completed 11,028-variable trace records with $runtime_solver_extension_timeout_count timeouts, and MadNLP independently completes $runtime_solver_madnlp_solved_count paired traces. The cross-solver ledger covers $runtime_solver_cross_both_solved_count/$runtime_solver_cross_pair_count paired snapshots. The 56,142-variable combined MV/LV probes reached the solver for $runtime_combined_large_probe_solver_count/$runtime_combined_large_probe_policy_count policies under one-iteration/five-second guards, $runtime_combined_budget_solver_count policies under the reviewed ten-iteration/30-second guard, and $runtime_combined_50iter_solver_count policies under the reviewed fifty-iteration/120-second guard. The feasibility-relaxed full-case probe is $runtime_combined_feasibility_status, with $runtime_combined_feasibility_init_scalars finite initialization scalars and total slack $(isnothing(runtime_combined_feasibility_slack) ? "unavailable" : string(round(runtime_combined_feasibility_slack; digits=3))) A; it is useful initialization evidence but does not establish hard feasibility. The follow-up start-transfer probe is $runtime_combined_transfer_status, applying $runtime_combined_transfer_applied voltage starts; native/transfer solve allocation observations are $(isnothing(runtime_combined_transfer_native_bytes) ? "unavailable" : string(runtime_combined_transfer_native_bytes))/$(isnothing(runtime_combined_transfer_bytes) ? "unavailable" : string(runtime_combined_transfer_bytes)) bytes, and remain process-local rather than allocator-peak evidence. Its fresh-child companion has $runtime_combined_isolated_measured_count measured repetition(s) with a Sys.maxrss range $(isempty(runtime_combined_isolated_peak_range) ? "unavailable" : string(runtime_combined_isolated_peak_range)) bytes; Darwin malloc_zone_statistics is available for current allocator deltas $(isempty(runtime_combined_allocator_delta_range) ? "unavailable" : string(runtime_combined_allocator_delta_range)) bytes, but the allocator peak field is available in $runtime_combined_allocator_peak_available_count repetition(s) and remains unavailable here. The iteration-budget sweep is $runtime_combined_transfer_budget_sweep_status with $runtime_combined_transfer_budget_sweep_completed completed budgets $(runtime_combined_transfer_budget_sweep_budgets); native statuses $(get(runtime_combined_transfer_budget_sweep_termination_statuses, "native", Any[])) and transferred statuses $(get(runtime_combined_transfer_budget_sweep_termination_statuses, "feasibility_voltage_transfer", Any[])) show all_hard_runs_iteration_limited=$runtime_combined_transfer_budget_sweep_all_limited. Its structural validator is $runtime_combined_transfer_budget_sweep_validation_status and confirms $runtime_combined_transfer_budget_sweep_high_budget_pairs upper-budget native/transfer pair(s) escaped iteration limits. The boundary summary is $runtime_combined_transfer_budget_boundary_status with upper-budget stability=$runtime_combined_transfer_budget_boundary_high_budget_stable; it retains paired primal/dual statuses and process-local solve-allocation deltas. The demand sweep is $runtime_combined_load_sweep_status with $runtime_combined_load_sweep_qualified_count paired hard local-solve point(s), and its validator is $runtime_combined_load_sweep_validation_status. The refinement sweep is $runtime_combined_load_boundary_refinement_status with validation=$runtime_combined_load_boundary_refinement_validation_status; it narrows the paired local-solve point to 0.25 versus 0.30 demand multiplier. The MadNLP boundary check is $runtime_combined_madnlp_boundary_status with validation=$runtime_combined_madnlp_boundary_validation_status; it reproduces the 0.25 success and 0.30 iteration-limited boundary under a second solver. The cross-solver consistency ledger is $runtime_combined_solver_boundary_consistency_status with $runtime_combined_solver_boundary_agreement_count/2 boundary rows agreeing. The fine Ipopt sweep is $runtime_combined_load_fine_boundary_status with validation=$runtime_combined_load_fine_boundary_validation_status; it narrows the fixture transition to the 0.27/0.28 interval. This is isolated high-water/current-allocator, bounded convergence, and fixture-demand evidence, not a portable allocator-peak guarantee, physical demand threshold, or production scaling policy. Its extension plan was $runtime_solver_plan_status for $runtime_solver_plan_case_count reviewed cases. Allocator-level peak-memory measurements and converged hard-OPF larger-ladder evidence remain open.",
        ["docs/sparse_runtime_memory_scaling_summary.json", "docs/sparse_runtime_memory_isolated_summary.json", "docs/sparse_runtime_trend_summary.json", "docs/runtime_scaling_readiness_summary.json", "docs/bmopf_solver_scaling_readiness_summary.json", "docs/bmopf_solver_scaling_extension_plan.json", "docs/bmopf_solver_scaling_extension_summary.json", "docs/bmopf_solver_scaling_extension_madnlp_summary.json", "docs/bmopf_solver_scaling_cross_solver_summary.json", "docs/bmopf_combined_mv_lv_large_probe_summary.json", "docs/bmopf_combined_mv_lv_budget_extension_summary.json", "docs/bmopf_combined_mv_lv_50iter_probe_summary.json", "docs/bmopf_combined_mv_lv_feasibility_probe_summary.json", "docs/bmopf_combined_mv_lv_feasibility_start_transfer_summary.json", "docs/bmopf_combined_mv_lv_feasibility_start_transfer_isolated_summary.json", "docs/bmopf_combined_mv_lv_transfer_budget_sweep_summary.json", "docs/bmopf_transfer_budget_sweep_validation_summary.json", "docs/bmopf_transfer_budget_boundary_summary.json", "docs/bmopf_combined_mv_lv_load_multiplier_sweep_summary.json", "docs/bmopf_combined_mv_lv_load_sweep_validation_summary.json", "docs/bmopf_combined_mv_lv_load_boundary_refinement_summary.json", "docs/bmopf_combined_mv_lv_load_boundary_refinement_validation_summary.json", "docs/bmopf_combined_mv_lv_madnlp_boundary_summary.json", "docs/bmopf_combined_mv_lv_madnlp_boundary_validation_summary.json", "docs/bmopf_combined_mv_lv_solver_boundary_consistency_summary.json", "docs/bmopf_combined_mv_lv_load_fine_boundary_summary.json", "docs/bmopf_combined_mv_lv_load_fine_boundary_validation_summary.json", "benchmarks/summarize_bmopf_solver_scaling_readiness.jl", "benchmarks/plan_bmopf_solver_scaling_extension.jl", "benchmarks/summarize_bmopf_solver_scaling_extension.jl", "benchmarks/summarize_bmopf_solver_scaling_cross_solver.jl", "benchmarks/summarize_bmopf_combined_mv_lv_large_probe.jl", "benchmarks/summarize_bmopf_combined_mv_lv_budget_extension.jl", "benchmarks/summarize_bmopf_combined_mv_lv_50iter_probe.jl", "benchmarks/bmopf_combined_mv_lv_feasibility_probe.jl", "benchmarks/bmopf_combined_mv_lv_feasibility_start_transfer.jl", "benchmarks/profile_bmopf_combined_mv_lv_feasibility_start_transfer_isolated.jl", "benchmarks/run_bmopf_combined_mv_lv_feasibility_start_transfer_child.jl", "benchmarks/bmopf_combined_mv_lv_transfer_budget_sweep.jl", "benchmarks/validate_bmopf_transfer_budget_sweep.jl", "benchmarks/summarize_bmopf_transfer_budget_boundary.jl", "benchmarks/bmopf_combined_mv_lv_load_multiplier_sweep.jl", "benchmarks/validate_bmopf_combined_mv_lv_load_sweep.jl", "benchmarks/validate_bmopf_combined_mv_lv_load_boundary_refinement.jl", "benchmarks/validate_bmopf_combined_mv_lv_madnlp_boundary.jl", "benchmarks/validate_bmopf_combined_mv_lv_solver_boundary_consistency.jl", "benchmarks/validate_bmopf_combined_mv_lv_load_fine_boundary.jl"],
        blocking=true,
    ),
    gate(
        ...
        ["docs/analyze_runtime_scaling_summary.json", "docs/analyze_runtime_trend_summary.json", "docs/analyze_runtime_resource_summary.json", "docs/bmopf_analyze_runtime_profile_summary.json", "docs/bmopf_analyze_runtime_isolated_summary.json", "docs/bmopf_analyze_runtime_isolated_clean_summary.json", "docs/bmopf_analyze_portability_summary.json", "docs/bmopf_analyze_external_peak_probe_summary.json", "docs/bmopf_analyze_external_peak_probe_clean_summary.json", "docs/bmopf_analyze_external_peak_portability_summary.json", "docs/bmopf_analyze_allocator_telemetry_summary.json", "docs/bmopf_analyze_allocator_telemetry_clean_summary.json", "docs/bmopf_analyze_allocator_telemetry_portability_summary.json", "docs/bmopf_analyze_allocator_boundary_summary.json", "docs/analyze_scaling_readiness_summary.json", "docs/analyze_static_optimization_ab_summary.json", "docs/analyze_static_optimization_generalization_summary.json", "docs/analyze_static_target_terms_summary.json", "docs/bmopf_combined_mv_lv_analyze_scaling_summary.json", "benchmarks/probe_bmopf_analyze_external_peak.jl", "benchmarks/compare_bmopf_analyze_external_peak.jl", "benchmarks/probe_bmopf_analyze_allocator_telemetry.jl", "benchmarks/compare_bmopf_analyze_allocator_telemetry.jl", "benchmarks/review_bmopf_analyze_allocator_boundary.jl"],
        blocking=true,
    ),
    gate(
    ...
    gate(
        ...
        [
            ...
            "docs/bmopf_transfer_report_validation_summary.json",
            "docs/bmopf_transfer_report_isolated_validation_summary.json",
            "benchmarks/review_api_ownership_decisions.jl",
            "benchmarks/audit_bmopf_voltage_start_api.jl",
            "benchmarks/validate_bmopf_transfer_report.jl",
        ],
        blocking=true,
    ),
]
...
for gate in gates
    ...
    elseif gate["id"] == "analyze_runtime_scaling"
        gate["rationale"] *= " The matched portability candidate has semantic status=$analyze_portability_semantic_status and resource comparison status=$analyze_portability_resource_status; resource differences remain descriptive and do not establish portable performance or allocator peaks. An independent OS peak probe is status=$analyze_external_peak_status via $analyze_external_peak_tool for one representative child; its second-environment comparison is status=$analyze_external_peak_portability_status. Stage allocator telemetry is status=$analyze_allocator_status with peak-field availability in $analyze_allocator_peak_count stage(s); its second-environment comparison is $analyze_allocator_portability_status. The explicit allocator boundary review is $analyze_allocator_boundary_status. These remain local observations and do not close the allocator-level or portability gate."
    end
end
