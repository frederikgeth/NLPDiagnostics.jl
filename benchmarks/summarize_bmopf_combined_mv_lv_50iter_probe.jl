...
policy_records = [Dict{String,Any}(
    ...
    "start_values_native_count" => get(record, "start_values_native_count",
        get(record, "start_values_applied_count", 0) - get(record, "start_values_bound_aware_count", 0)),
    "start_values_missing_count" => get(record, "start_values_missing_count",
        get(record, "start_values_bound_aware_count", 0)),
