...
const ACTIONS = Dict{String,Dict{String,Any}}(
    ...
    "runtime_memory_scaling" => Dict(
        "priority" => 3,
        "next_deliverable" => "Map the converged feasibility-relaxed initialization into a hard full-case OPF start, then add allocator-level peak telemetry before making a production scaling claim.",
