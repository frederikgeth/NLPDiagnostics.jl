...
4. **`analyze_runtime_scaling`** — Repeat the cached affine-row A/B on broader point-free analyze workload families and retain explicit portability limits.
