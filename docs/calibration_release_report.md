...
4. **`analyze_runtime_scaling`** — Extend cross-environment allocator-level memory and reproducibility evidence for the reviewed analyze workloads.
