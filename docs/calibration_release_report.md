...
4. **`analyze_runtime_scaling`** — Extend the guarded combined MV+LV analyze profile to additional feeders or a larger reviewed snapshot, and select the next static-stage optimization candidate.
