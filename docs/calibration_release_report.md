...
1. **`numerical_rank_false_positive_negative_statistics`** — Register a reviewed third rank backend and run a reproducible cross-backend campaign with disagreement records.
