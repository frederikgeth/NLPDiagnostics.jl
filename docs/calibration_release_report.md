...
4. **`analyze_runtime_scaling`** — Select the next semantics-preserving static-stage optimization candidate and extend cross-environment allocator-level memory and reproducibility evidence.
