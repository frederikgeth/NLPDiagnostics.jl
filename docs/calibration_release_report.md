...
4. **`analyze_runtime_scaling`** — Extend point-free analyze scaling to reviewed BMOPFTools combined MV+LV workload families and select the next static-stage optimization candidate.
