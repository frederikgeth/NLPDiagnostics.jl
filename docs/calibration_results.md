...
changing public behavior: 506 root exports, 110 root testsets across nine
included test modules, 103 benchmark scripts, and schema versions on all 42
JSON artifacts. It also counts 28 bare source `catch` boundaries and finds no
explicit typed unavailable-reason token or advanced/experimental namespace.
