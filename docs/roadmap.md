...
complexity claims. The next deliverable is to decide whether a second solver or
larger guarded case is justified, then extend the readiness ledger with any
