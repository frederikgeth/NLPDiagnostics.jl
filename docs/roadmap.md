...
`docs/api_ownership_decision_summary.json`. Fifty-two high-impact root-only
names were reviewed from the usage queue: twenty retain root compatibility and
thirty-two BMOPF-specific helpers remain Advanced candidates. No export is moved,
