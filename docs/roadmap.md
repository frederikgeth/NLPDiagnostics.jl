...
seven reviewed evidence rows on local-solve, physical-endpoint, comparison,
...
supported. It also carries the 0.25 feasible boundary and nominal-demand
follow-up into one acceptance checklist. This is a process-integrity
deliverable, not a new physical or solver-superiority claim.
