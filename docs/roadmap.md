...
`benchmarks/real_99bus_phase_only_structured_perturbation_matrix.jl` to
`benchmarks/common.jl`, bringing the shared helper to sixty-three core runners
while preserving the four-case block-perturbation schema. Its bounded local
...
sixty-three core release, rank, runtime, and audit runners; the BMOPF campaign and
