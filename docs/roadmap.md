...
MiB total memory against the declared 8,192 MiB envelope, but only about 3,336
MiB free at assessment time. The current status is therefore
...
the additional free memory required to satisfy the envelope. At the recorded
assessment point, the host had a positive total-capacity margin but required
about 4,856 MiB of additional free memory before launch. These margins are
point-in-time telemetry, not a reservation or guarantee.
