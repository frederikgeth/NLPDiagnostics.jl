...
include("numerics/dependent_rows.jl")
...
export SparseQRNullspacePersistenceEstimate
...
export physical_endpoint_equivalence_report
export scaling_solver_experiment_comparison
export scaling_solver_experiment_campaign_data
export scaling_solver_experiment_stratified_campaign_data
export iteration_trace_jacobian_family_geometry_data
...
export solver_linear_telemetry_data
...
export iteration_trace_policy_comparison
...
export jacobian_row_family_scale_attribution
export jacobian_column_family_scale_attribution
export jacobian_family_geometry_comparison
...
export scaling_intervention_classification
...
export sparse_qr_nullspace_persistence
...
export analyze_sparse_qr_nullspace_persistence
...
export component_rank_capability_report
...
export powermodels_component_rank_capability_report
...
export bmopf_variable_semantic_column_map
export bmopf_iteration_trace_jacobian_family_geometry_data
...
export bmopf_phase_only_transform_plan
...
export bmopf_phase_only_physical_solver_kkt_report
export bmopf_phase_only_covariance_report
...
export bmopf_scaling_solver_experiment_comparison
...
export bmopf_scaling_intervention_classification
...
export bmopf_analyze_active_set
export bmopf_analyze_reduced_hessian_persistence
export bmopf_analyze_jacobian_rank_persistence
export bmopf_analyze_sparse_qr_nullspace_persistence
export bmopf_analyze_component_rank_persistence
...
export bmopf_opf_differentiability_report
export bmopf_opf_registry_report
export bmopf_component_metadata
...
export bmopf_source_behavior_auxiliary_model
export bmopf_source_behavior_auxiliary_solve
export bmopf_source_behavior_report
export bmopf_source_behavior_solver_comparison
...
function analyze_elastic_domain_guard_plan(plan::ElasticDomainGuardPlan)
    ...
    for guard in plan.guards
        ...
        push!(report, Finding(
            ...
            observation = "The plan records an elastic-scope constraint applying $(guard.operator) at path $(join(guard.path, "/")) where $(guard.requirement).",
            why_it_matters = "The stored assessment is not revalidated against a source model by this report. Relaxing a constraint residual does not make an undefined nonlinear operator evaluable; auxiliary slack evidence is unreliable outside this operator domain.",
